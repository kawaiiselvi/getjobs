...
class GuestController extends Controller
{
    public function index(Request $request, Builder $htmlBuilder)
    {
        ...
        $html = $htmlBuilder
        ->addColumn(['data'=>'title','name'=>'title','title'=>'Lowongan'])
        ->addColumn(['data'=>'stock','name'=>'stock','title'=>'Gaji','orderable'=>false,'searchable'=>false])
        ->addColumn(['data'=>'author.name','name'=>'author.name','title'=>'Perusahaan'])
